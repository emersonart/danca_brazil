  ...
  $.extend($.summernote.plugins, {
    'videoAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        '      <option value="center">' + lang.videoAttributes.alignmentOption3 + '</option>' +
      ...
      this.show = function () {
        ...
        this.showLinkDialog(vidInfo).then(function (vidInfo) {
          ...
          var $vid            = vidInfo.vidDom,
              ...
              $videoHTML      = $('<div/>');
          if ($videoSize.val() == 0) {
            if($videoAlignment.val() == 'center'){
              class_center = 'mx-auto text-center';
            }
            $videoHTML.addClass('embed-responsive embed-responsive-16by9 '+class_center);
          ...
          if($videoAlignment.val() == 'center'){
            $video.addClass('mx-auto text-center').css({'margin-left':'auto','margin-right':'auto','float':'none'});
          }
