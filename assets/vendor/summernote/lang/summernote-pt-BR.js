  ...
  $.extend($.summernote.lang, {
    'pt-BR': {
      ...
      videoAttributes: {
        ...
        pluginTitle: 'Inserir Vídeo',
        href: 'URL',
        videoSize: 'Tamanho do vídeo',
        videoOption0: 'Responsivo',
        videoOption1: '1280x720',
        videoOption2: '853x480',
        videoOption3: '640x360',
        videoOption4: '560x315',
        alignment: 'Alinhamento',
        alignmentOption0: 'Nenhum',
        alignmentOption1: 'Esquerda',
        alignmentOption2: 'Direita',
        alignmentOption3: 'Centralizado',
        alignmentOption4: 'Padrão',
        suggested: 'Mostrar vídeos relacionados ao terminar',
        controls: 'Mostrar controladores',
        autoplay: 'Autoplay',
        loop: 'Repetir',
        note: 'Aviso: Nem todas as opções estão disponíveis em todos os serviços',
        ok: 'OK'
      },
      file: {
        file: 'Arquivo',
        btn: 'Arquivo',
        insert: 'Inserir Arquivo',
        selectFromFiles: 'Selecionar Arquivo',
        url: 'URL',
        maximumFileSize: 'Tamanho máximo do arquivo',
        maximumFileSizeError: 'Tamanho máximo do arquivo maior do que o permitido'
      }
    },
  });
})(jQuery);
