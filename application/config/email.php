...
$config['smtp_host']        = 'mail.hennekamwines.com';
...
$config['smtp_user']        = 'no-reply@hennekamwines.com';
$config['smtp_pass']        = 'jOE9@=(cJHF~';
...
$config['debug_output']     = 'mailer_log';                       // PHPMailer's SMTP debug output: 'html', 'echo', 'error_log' or user defined function with parameter $str and $level. NULL or '' means 'echo' on CLI, 'html' otherwise.
