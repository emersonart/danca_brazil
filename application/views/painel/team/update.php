            	...
            	<?=form_open_multipart()?>
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="tea_name" id="tea_name" value="<?=$team['tea_name']?>" placeholder="Nome">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="tea_link"  placeholder="Link rede social" value="<?=$team['tea_link']?>">
