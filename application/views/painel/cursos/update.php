            	...
            	<?=form_open_multipart()?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                    <input type="text" autocomplete="off" class="form-control form-round form-creser" name="cur_title_pt_br" id="cur_title_pt_br" value="<?=$curso['cur_title_pt_br']?>" placeholder="Nome em Português">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                    <input type="text" autocomplete="off" class="form-control form-round form-creser" name="cur_title_en" id="cur_title_en" value="<?=$curso['cur_title_en']?>" placeholder="Nome em Ingês">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-4">
                                ...
                                <small class="text-muted">Foto <a href="#" data-target="#visualizar_imagem_tes" data-toggle="modal" data-imagem="<?=$curso['cur_image']?>">Visualizar</a></small>
                            </div>
                            
                        </div>
                        <div class="col-md-6">
                            <div class="custom-control custom-switch custom-switch-md">
                                <input type="checkbox" class="custom-control-input" name="cur_show" value="1" id="customSwitch1" <?=$curso['cur_show'] == 1 ? 'checked' : ''?>>
                    	...
                    	<div class="col-md-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="pt_br" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group">
                                        <textarea name="cur_description_pt_br" id="cur_description_pt_br" class="form-control" rows="10"><?=$curso['cur_description_pt_br']?></textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade show" id="en" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group">
                                        <textarea name="cur_description_en" id="cur_description_en" class="form-control" rows="10"><?=$curso['cur_description_en']?></textarea>
                                    </div>
                                </div>
                            </div>
