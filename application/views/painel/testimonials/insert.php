                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                    <input type="text" autocomplete="off" class="form-control form-round form-creser" name="tes_name" id="use_name" value="<?=set_value('tes_name')?>" placeholder="Título em Português">
                        ...
                        <div class="col-md-6">
                            <div class="custom-control custom-switch custom-switch-md">
                                <input type="checkbox" class="custom-control-input" name="tes_show" value="1" id="customSwitch1" checked>
                    	...
                    	<div class="col-md-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="pt_br" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group">
                                        <textarea name="tes_testimonial_pt_br" id="tes_testimonial_pt_br" class="form-control" rows="10"><?=set_value('tes_testimonial_pt_br')?></textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade show" id="en" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group">
                                        <textarea name="tes_testimonial_en" id="tes_testimonial_en" class="form-control" rows="10"><?=set_value('tes_testimonial_en')?></textarea>
                                    </div>
                                </div>
                            </div>
