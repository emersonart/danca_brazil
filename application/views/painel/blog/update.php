            	...
            	<?=form_open_multipart()?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="blo_title_pt_br" id="title_to_pt_br" placeholder="Título em Português"  value="<?=$news['blo_title_pt_br']?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="blo_title_en" id="title_to_en" placeholder="Título em Inglês" value="<?=$news['blo_title_en']?>" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="blo_link" id="no_caracter" placeholder="Link personalizado" value="<?=$news['blo_link']?>" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                foreach ($news['tags'] as $key => $value) {
                                    $arrr[$value['tag_id']] = $value['tag_id'];
                                }
                                ...
                                echo form_dropdown('tags[]',$tags,$arrr,$js)?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <small class="text-muted">Imagem usada para compartilhamento em redes sociais <a href="#" data-target="#visualizar_imagem_blo" data-toggle="modal" data-imagem="<?=$news['blo_image']?>">Visualizar</a></small>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <small class="text-muted">Imagem usada no cabeçalho do post <a href="#" data-target="#visualizar_imagem_blo" data-toggle="modal" data-imagem="<?=$news['blo_cover']?>">Visualizar</a></small>
                                    </div>
