            	...
            	<?=form_open_multipart()?>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="vid_title_pt_br" id="title_to_pt_br" value="<?=set_value('vid_title_pt_br')?>" placeholder="Título em Português">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="vid_title_en" id="title_to_en" value="<?=set_value('vid_title_en')?>" placeholder="Título em Inglês">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="has-float-label">
                                <input type="text" autocomplete="off" class="form-control form-round form-creser" name="vid_link"  placeholder="Link do Vídeo" value="<?=set_value('vid_link')?>">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="custom-control custom-switch custom-switch-md">
                                <input type="checkbox" class="custom-control-input" name="vid_show" value="1" id="customSwitch1" <?php echo set_checkbox('vid_show', '1',true); ?> >
                    	...
                    	<div class="col-md-12">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="pt_br" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group">
                                        <textarea name="vid_description_pt_br" id="vid_description_pt_br" class=" form-control" rows="10"><?=set_value('vid_description_pt_br')?></textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade show" id="en" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-group">
                                        <textarea name="vid_description_en" id="vid_description_en" class=" form-control" rows="10"><?=set_value('vid_description_en')?></textarea>
                                    </div>
                                </div>
                            </div>
