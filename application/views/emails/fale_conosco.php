		...
		<table width="100%" cellspacing="0" cellpadding="0" align="center" >
		                        ...
		                        <table width="90%" cellspacing="0" cellpadding="20" align="center" style="border-collapse:separate; overflow:hidden;-webkit-border-radius: 15px;-moz-border-radius: 15px;border-radius: 15px;-webkit-box-shadow: 0px 0px 18px 3px rgba(224,224,224,0.75);-moz-box-shadow: 0px 0px 18px 3px rgba(224,224,224,0.75);box-shadow: 0px 0px 18px 3px rgba(224,224,224,0.75); border: solid 1px #f2f2f2;background: white;margin-bottom: 25px">
		                            <tr>
		                                <td bgcolor="#FFFFFF" align="center" colspan="2">
		                                    ...
		                                    <br>
		                                    <h4 style="color:#7f1d5a; font-weight: normal; font-family: Arial, Tahoma; padding-bottom: 0px; margin-bottom: 0px;"><?=$assunto?></h4>
		                                </td>
		                            </tr>
		                            <tr>
		                                <td colspan="2">
		                            ...
		                            <tr>
		                            	<td align="right" style="padding-top: 0px;">Nome:</td>
		                                <td align="left" style="padding-top: 0px;">
		                                    <p><b><?=$nome;?></b><br></p>
		                                </td>
		                            </tr>
		                            <tr>
		                                <td align="right" style="padding-top: 0px;">Assunto:</td>
		                                <td align="left" style="padding-top: 0px;">
		                                    <p><b><?=$assunto?></b></p>
		                                </td>
		                            </tr>
		                            <tr>
		                                <td align="right" style="padding-top: 0px;">E-mail:</td>
		                                <td align="left" style="padding-top: 0px;">
		                                    <p><b><?=$email_send?></b></p>
		                                </td>
		                            </tr>
		                            <tr>
		                                <td align="right" style="padding-top: 0px;">Data e hora:</td>
		                                <td align="left" style="padding-top: 0px;">
		                                    <p><b><?=$dataehora?></b></p>
		                                </td>
		                            </tr>
		                            <tr>
		                                <td align="right" style="padding-top: 0px;">Telefone:</td>
		                                <td align="left" style="padding-top: 0px;">
		                                    <p><b><?=$telefone?></b></p>
		                                </td>

		                                    <?php if(isset($cidade) && $cidade){ ?>
		                                    	</tr>
		                            			<tr>
		                                    	<td align="right" style="padding-top: 0px;">Cidade:</td>
		                                    	<td align="left" style="padding-top: 0px;">
			                                    	<p><b><?=$cidade?></b></p>
			                                    </td>
			                                    </tr>
		                            <tr>
			                                    <td align="right" style="padding-top: 0px;">Estado:</td>
		                                    	<td align="left" style="padding-top: 0px;">
			                                    	<p><b><?=$estado?></b></p>
			                                    </td>
			                                    </tr>
		                            <tr>
		                                    	<td align="right" style="padding-top: 0px;">País:</td>
		                                    	<td align="left" style="padding-top: 0px;">
			                                    	<p><b><?=$pais?></b></p>
			                                    </td>
		    ...
		    <tr>
		        <td align="center" style="font-family:Arial,Tahoma; color: #6f6f6f;  font-size: 0.8em;background:white;margin-top: 20px;">
		            <br>
		            <a href="<?=base_url()?>" style="color:#003366;text-decoration:none;">Henekkam</a>
		        </td>
		    </tr>
		</table>
	</body>
